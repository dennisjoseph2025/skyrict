...
# FIN-AI-004 (SKY-81/SKY-83): document & tax AI suite.
FINANCE_AI_TAX_SUMMARY_GENERATED = "finance.ai.tax_summary.generated"
FINANCE_AI_TAX_SUMMARY_APPROVED = "finance.ai.tax_summary.approved"
FINANCE_AI_TAX_SUMMARY_REJECTED = "finance.ai.tax_summary.rejected"
