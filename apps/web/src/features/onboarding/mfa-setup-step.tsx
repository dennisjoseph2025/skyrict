    ...
    async function regenerate() {
        ...
        try {
            ...
            setRegenerateError(
                err instanceof Error
                    ? err.message
                    : "Could not regenerate codes. Try again.",
            );
        } finally {
            ...
            <div className="flex items-start gap-3 rounded-lg border border-primary/40 bg-primary/10 p-4">
                ...
                <div className="space-y-1 text-sm">
                    <p className="font-medium text-foreground">
                        Mandatory for your security
                    </p>
                    <p className="text-xs text-muted-foreground">
                        Two-factor authentication is required for every Skyrict
                        workspace. You&apos;ll need it the next time you sign
                        in.
                    </p>
                </div>
            </div>
                    ...
                    <div className="space-y-3">
                        ...
                        {error ? (
                            ...
                            <p className="text-center text-xs text-muted-foreground">
                                Open your authenticator app and scan the code to
                ...
                <div className="space-y-5">
                    ...
                    <div className="rounded-xl border border-border bg-muted/40 p-4">
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">
                            Store these in a safe place. Each works once to sign
                            in if you lose your authenticator app.
                        </p>
                        ...
                        {regenerated ? (
                            <p className="mt-3 text-center text-xs font-medium text-primary">
                                New codes generated. Save them and delete the
                                old list.
                            </p>
                        ) : null}
                        {regenerateError ? (
