...
const provisionSteps = [
    ...
    {
        label: "Creating identity",
        detail: "Encrypting your sign-in credentials",
    },
    {
    ...
    {
        label: "Applying security policies",
        detail: "Enabling MFA and recovery",
    },
...
function ProvisioningScreen({ onComplete }: { onComplete: () => void }) {
    ...
    const progress = Math.max(
        0,
        Math.min(1, (index + 1) / provisionSteps.length),
    );
