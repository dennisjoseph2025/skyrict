...
const ACTIVE_STATUS_OPTIONS: {
    value: "all" | Exclude<EmployeeStatus, "terminated">;
    label: string;
}[] = [
...
export function EmployeesClient({
    ...
    const [statusFilter, setStatusFilter] = useState<
        "all" | Exclude<EmployeeStatus, "terminated">
    >("all");
    ...
    const [invitingEmployee, setInvitingEmployee] = useState<Employee | null>(
        null,
    );
        ...
        <div className="space-y-6">
                    ...
                    <SearchableSelect
                        ...
                        onValueChange={(value) => {
                            setStatusFilter(
                                value as
                                    | "all"
                                    | Exclude<EmployeeStatus, "terminated">,
                            );
                            setPage(1);
                        }}
                        placeholder="Status"
            ...
            {status.state === "ready" ? (
                <ErpDataTable
                    ...
                    onRowClick={(employee) =>
                        router.push(
                            `/dashboard/erp/hr/employees/${employee.id}`,
                        )
                    }
                />
            ) : null}
