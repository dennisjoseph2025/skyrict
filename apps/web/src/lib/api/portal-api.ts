...
export type PortalLeaveRequestStatus =
...
function mapLeaveRequest(
    payload: PortalLeaveRequestPayload,
): PortalLeaveRequest {
    return {
        id: String(payload.id ?? ""),
        ...
        approvedAt:
            payload.approved_at == null ? null : String(payload.approved_at),
        createdAt: String(payload.created_at ?? ""),
    };
}

function mapSuggestion(
    payload: PortalSuggestionPayload,
): PortalLeaveSuggestion {
    return {
